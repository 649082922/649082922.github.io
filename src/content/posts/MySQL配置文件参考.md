...
description: "datadir=C:/ProgramData/MySQL/MySQL Server 8.0Data"
tags: ["MySQL", "实战笔记"]
category: 数据库
draft: false
---
...
general_log_file="LAPTOP-LRAT6QCM.log"

slow-query-log=1

slow_query_log_file="LAPTOP-LRAT6QCM-slow.log"

long_query_time=10

# Error Logging.
log-error="LAPTOP-LRAT6QCM.err"

# ***** Group Replication Related *****
# Specifies the base name to use for binary log files. With binary logging
# enabled, the server logs all statements that change data to the binary
# log, which is used for backup and replication.
log-bin="LAPTOP-LRAT6QCM-bin"
